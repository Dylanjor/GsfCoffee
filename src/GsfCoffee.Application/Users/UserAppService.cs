...
using GsfCoffee.Authorization.Accounts;
...
namespace GsfCoffee.Users
{
    ...
    class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
